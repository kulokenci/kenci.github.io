...
if($_GET['edition_id'] != "" && $_GET['lang'] != ""){
	$edition_id = $_GET['edition_id'];
	$lang = $_GET['lang'];
	$url = qr_loadUrl('https://tb.rg-adguard.net/php/get_language.php?edition_id='.$edition_id.'&lang='.$lang);
    echo $url;
} else {
    $url = qr_loadUrl('https://tb.rg-adguard.net/php/get_language.php');
    echo $url;
}
?>