...
if($_GET['version_id'] != "" && $_GET['lang'] != ""){
	$version_id = $_GET['version_id'];
	$lang = $_GET['lang'];
	$url = qr_loadUrl('https://tb.rg-adguard.net/php/get_edition.php?version_id='.$version_id.'&lang='.$lang);
    echo $url;
} else {
    $url = qr_loadUrl('https://tb.rg-adguard.net/php/get_edition.php');
    echo $url;
}
?>